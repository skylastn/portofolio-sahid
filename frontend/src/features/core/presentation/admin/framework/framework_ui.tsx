      ...
      <div className={`rounded-[1.8rem] p-6 ${theme.shellCardClass}`}>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h3 className={`mt-2 text-2xl font-black ${theme.headingClass}`}>Framework list</h3>
          </div>
          <button
            type="button"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-2xl rounded-[1.75rem] border border-white/10 bg-slate-950 p-6">
            ...
            <div className="mt-6 grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
              {[
                ["Code language", selectedFramework.code_language_id],
                ["Description", selectedFramework.description],
                ["Image path", selectedFramework.image_path],
                ["Updated", selectedFramework.updated_at ? new Date(selectedFramework.updated_at).toLocaleString() : "-"],
              ].map(([label, value]) => (
          ...
          <div className="w-full max-w-4xl rounded-[1.75rem] border border-white/10 bg-slate-950 p-6">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <label className="flex flex-col gap-2">
                <span className="text-sm font-semibold text-slate-200">Code language</span>
                <select
